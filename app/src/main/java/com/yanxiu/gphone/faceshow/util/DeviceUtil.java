...
public class DeviceUtil {
    public static String getAppDeviceId() {
        ...
        TelephonyManager telephonyManager = (TelephonyManager) FaceShowApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
        String deviceId = telephonyManager.getDeviceId();

        WifiManager wifiManager = (WifiManager) FaceShowApplication.getInstance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
