...
public class SystemUtil {
    ...
    public static String getChannelName() {
        ...
        try {
            PackageManager packageManager = FaceShowApplication.getInstance().getPackageManager();
            if (packageManager != null) {
                ApplicationInfo applicationInfo = packageManager.getApplicationInfo(FaceShowApplication.getInstance().getPackageName(), PackageManager.GET_META_DATA);
